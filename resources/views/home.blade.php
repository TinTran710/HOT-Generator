...
@section('content')
  ...
  <a href="form"><button type="button" class="btn btn-danger">Instances <span class="badge"></span></button></a>
  <button type="button" class="btn btn-primary">Networks <span class="badge"></span></button>
